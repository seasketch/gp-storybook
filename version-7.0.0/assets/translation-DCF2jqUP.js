const n=`{
  ...
  "Activity": "Aktivitet",
  "Area": "Område",
  "Area Within Plan": "Område inom planen",
  "Attributes": "Attribut",
  "Author(s)": "Författare",
  "Boundary": "Gräns",
  "Category": "Kategori",
  ...
  "Found Within Plan": "Finns inom planen",
  "Full protection level label": "Full",
  "Goal": "Mål",
  "High protection level label": "Hög",
  "IUCN activity - aquaculture": "Vattenbruk - småskalighet",
  "IUCN activity - extraction": "Gruvdrift, olje- och gasutvinning",
  "IUCN activity - fishing sustainable": "Fiske/insamling: rekreation (hållbar)",
  "IUCN activity - habitation": "Boning",
  "IUCN activity - industrial fishing": "Industriellt fiske, vattenbruk i industriell skala",
  "IUCN activity - local fishing": "Fiske/insamling: lokalt fiske (hållbart)",
  "IUCN activity - non-extractive": "Icke-extraktiv rekreation",
  "IUCN activity - renewable": "Produktion av förnybar energi",
  ...
  "IUCN activity - traditional fishing": "Traditionellt fiske/insamling",
  "IUCN activity - traditional use": "Traditionell användning: icke-extraktiv",
  "IUCN activity - untreated water": "Obehandlat vattenutsläpp",
  "IUCN activity - works": "Arbeten (hamnar, hamnar, muddring)",
  ...
  "IUCN category 4": "Naturtop/artförvaltningsområde",
  "IUCN category 4 or 6": "Habitat/artförvaltningsområde eller skyddat område med hållbar användning",
  ...
  "IUCN rank - special 'variable' description": "Variabel; beror på om denna verksamhet kan förvaltas på ett sådant sätt att den är förenlig med Läkemedelsverkets mål",
  "IUCN rank - special no description": "I allmänhet nej, ett starkt privilegium mot om inte särskilda omständigheter gäller",
  ...
  "ReportError - message part 1": "Något gick fel. Stäng rapporten och försök igen.",
  "ReportError - message part 2": "Om felet kvarstår, vänligen rapportera det.",
  "Representation": "Representation",
  "Results not found": "Resultaten hittades inte",
  "ResultsCard - no result message": "Rapportkörningen slutfördes, men inga resultat returnerades",
  "Shoreline": "Strandlinjen",
  "Show by MPA": "Visa av MPA",
  "Size": "Storlek",
  "SizeCard - introduction": "Nationella vatten sträcker sig från strandlinjen ut till 200 nautiska mil, känd som den exklusiva ekonomiska zonen (EEZ). Denna rapport sammanfattar överlappning av offshore-planer med den exklusiva ekonomiska zonen och andra gränser inom den, och mäter framstegen mot att uppnå procentmål för varje gräns.",
  "SizeCard - learn more": "<0> Denna rapport sammanfattar planens storlek och andel inom dessa gränser.</0><p>Om skissgränserna inom en plan överlappar varandra räknas överlappningen bara en gång.</p>",
  "SizeCard - learn more source": "Källa: Wikipedia - Territorialvatten",
  "SizeCard sketch size message": "Denna skiss är <2>{{area}}</2> kvadratkilometer",
  "SizeCard title": "Zonens storlek",
  "Target": "Mål",
  "Value": "Värde",
  "Viability": "Livsduglighet",
  "# MPAs": "# MPA",
