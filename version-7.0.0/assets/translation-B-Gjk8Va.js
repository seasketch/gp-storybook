const e=`{
  ...
  "Activity": "Activity",
  "An error occurred while rendering this component. If the error persists, please report it.": "An error occurred while rendering this component. If the error persists, please report it.",
  "Area": "Area",
  "Attributes": "Attributes",
  "BlankCard": "BlankCard",
  "BlankCard Sketch Message": "This is a blank {{sketchStr}} with result {{dataStr}}.",
  "Boundary": "Boundary",
  "Category": "Category",
  "Class": "Class",
  ...
  "IUCN rank - special 'variable' description": "Variable; depends on whether this activity can be managed in such a way that it is compatible with the MPA’s objectives",
  ...
  "SimpleCard title": "Simple Report",
  "Size": "Size",
